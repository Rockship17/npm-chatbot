...
var ChatWidget = function (_a) {
    ...
    var loadMessages = (0, react_1.useCallback)(function (convId_1) {
        ...
        return __awaiter(void 0, __spreadArray([convId_1], args_1, true), void 0, function (convId, page) {
            var response, sortMessages, newMessages, error_2;
                    ...
                    case 1:
                        ...
                        if (response.data.message && response.data.message.length > 0) {
                            sortMessages = function (msgs) {
                                return __spreadArray([], msgs, true).sort(function (a, b) {
                                    return new Date(a.created_at).getTime() - new Date(b.created_at).getTime();
                                });
                            };
                            newMessages = page === 1
                                ? sortMessages(response.data.message)
                                : sortMessages(__spreadArray(__spreadArray([], messages, true), response.data.message, true));
