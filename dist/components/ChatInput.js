...
var ChatInput = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { className: "border-t bg-white p-4", children: (0, jsx_runtime_1.jsxs)("div", { className: "flex items-end gap-2", children: [(0, jsx_runtime_1.jsx)("textarea", { value: message, onChange: function (e) { return setMessage(e.target.value); }, onKeyPress: handleKeyPress, placeholder: "Nh\u1EADp tin nh\u1EAFn c\u1EE7a b\u1EA1n...", style: {
                        borderColor: "#e9ecef",
                    }, 
                    // Custom className with focus ring color based on theme
                    className: "flex-1 resize-none border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-opacity-50 max-h-24 focus:ring-".concat(((_b = theme === null || theme === void 0 ? void 0 : theme.primaryColor) === null || _b === void 0 ? void 0 : _b.replace("#", "")) || "007bff"), rows: 1, disabled: isLoading }), (0, jsx_runtime_1.jsx)("button", { onClick: handleSend, disabled: !message.trim() || isLoading, className: "px-4 py-2 rounded-lg text-white text-sm font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed", style: {
